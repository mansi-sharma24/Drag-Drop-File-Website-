# <h1>Drag-Drop-File-Website </h1>
Drag and Drop file upload means you'll upload the file by drag & drop. Drag and Drop interfaces enable web applications to tug and drop files on an internet page.In this  you'll able to upload the file by drag & drop or by clicking on the browse file button.
This website is made using HTML, CSS and JavaScript.

<img width="960" alt="2021-04-25 (3)" src="https://user-images.githubusercontent.com/73280986/115990100-2612fa00-a5df-11eb-8109-03ac471d75b9.png">
<br>
